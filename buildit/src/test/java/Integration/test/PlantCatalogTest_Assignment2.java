...
@WebAppConfiguration
//@ActiveProfiles("test")
public class PlantCatalogTest_Assignment2 {
	@Value("${rentit.host:}")
	String host;
...
//						POResource.class));
		...
		mockServer
				.expect(requestTo(host+"/rest/pos/10005/accept"))
				.andExpect(method(HttpMethod.DELETE))
				.andRespond(
						withSuccess(mapper.writeValueAsString(res), MediaType.APPLICATION_JSON));

		rentItProxy.rejectPO(
				new LocalDate(2014, 10, 6).toDate(),
				new LocalDate(2014, 10, 10).toDate(), 10005L);
